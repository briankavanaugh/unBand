...
namespace unBand
{
    ...
    {
        public static DependencyProperty IsHiddenProperty = DependencyProperty.RegisterAttached(("IsHidden"),
            typeof (bool), typeof (DesignHelpers),
            new FrameworkPropertyMetadata(false, OnIsHiddenChanged));
